    ...
    ->group(function ($router) {
        ...
        $router->middleware(['auth:admin'])->group(function($router) {
            ...
            $router->middleware(['admin.permission'])->group(function($router) {
                ...
                $router->get('role/{id}/assign-permissions', 'RoleController@assignPermissionsForm')->name('admin.role.assign.permissions.form');
                $router->put('role/{id}/assign-permissions', 'RoleController@assignPermissions')->name('admin.role.assign.permissions');
            });
        });
    });