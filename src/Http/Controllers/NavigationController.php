...
class NavigationController extends Controller
{
    ...
    {
        $navigation = Navigation::where('parent_id', 0)->orderBy('sequence','desc')->get();
        return view("admin::navigation.create", compact("navigation"));
    }
    ...
    {
        $navigation_list = Navigation::where('parent_id', 0)->orderBy('sequence','desc')->get();
        return view("admin::navigation.edit", compact("navigation", 'navigation_list'));
    }
